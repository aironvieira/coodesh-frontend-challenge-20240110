...
import CaretOrange from '../assets/images/carrotOrange.svg'
...
const NovosAnuncios: React.FC = () => {
    ...
    return (
        <section className="container pt-16 pb-16">
            <div>
                <h2 className="flex text-[20px] md:text-[24px] font-bold gap-2">Novos Anúncios em <span className="text-custom-orange">Belo Horizonte</span><Image src={CaretOrange} alt="Caret" width={16} height={16} className="hidden md:block"/></h2>
                <a href="#" className="flex text-[#2362AF] text-[16px] mb-5"> Ver todos imóveis <Image src={ExternalLink} alt="External Link" width={16} height={16}/></a>
            </div>
            <div className="pb-4">
                <Swiper
