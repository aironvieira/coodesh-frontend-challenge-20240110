    ...
    return (
      <section className="container pt-16 pb-16 grid grid-cols-1 lg:grid-cols-2 gap-4 justify-between">
        <div className='md:w-[495px]'>
            <h2 className='text-custom-medium-grey-text text-[34px] md:text-[60px] leading-tight font-semibold'>Encontre um lugar que é a sua cara</h2>
        ...
        <div className='md:w-[513px] md:h-[470px] bg-white rounded-md ml-auto'>
