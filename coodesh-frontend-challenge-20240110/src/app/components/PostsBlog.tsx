...
const PostsBlog: React.FC = () => {
    ...
    return (
        <section className={`container mb-20`}>
            <div className='flex flex-col md:flex-row gap-2 md:gap-0 justify-between md:items-center mb-6 mt-20'>
                <h2 className='font-bold text-[20px] md:text-[34px] text-custom-dark-grey'>Para compradores, vendedores e curiosos :)</h2>
            ...
            <div className='posts grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 items-center gap-8'>
                <div className='post w-[305px] md:w-[384px] m-auto mt-0 '>
                    <Image
                        src={Connections}
                        alt="Evento Connections"
                        className="object-cover rounded-xl mb-4 h-[225px] md:h-[252px]"
                        />
